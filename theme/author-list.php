	...
	<div class="container">
		...
		<div id="main" class="col_9">
			...
			<?php foreach ($users as $user): ?>
				<?php $grade = get_user_grade($user); if ( !$grade['is_active'] ) continue; ?>
				<?php $uid = $user->ID; ?>
					...
					<div class="profile">
						<div class="name-grade-box">
							...
							<div class="social-accounts">
								<?php if ( $user->user_url ): //ウェブサイト ?>
									<span class="social-account"><a href="<?php echo $user->user_url ?>"><i class="icon-website"></i></a></span>
								<?php endif; ?>
